...
import { canReviewRequests } from '@/lib/routeAccess'
...
export default function Requests() {
  ...
  const month = useMemo(
    () => monthKey(filters.from || new Date()),
    [filters.from]
  )
  ...
  return (
    <div data-testid="screen-requests">
      ...
      <BookingConfirmation message={bookingConfirmation} />
      ...
      <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
        <RequestsToolbar
          ...
          showEmployeeFilters={showingTeam}
      ...
      <div className="flex flex-col gap-4 rounded-2xl bg-background-secondary p-4 sm:p-6">
        ...
        {showingTeam && (
          <RequestDateStrip month={month} highlighted={highlightedDates} />
        )}
        ...
        <RequestsTable
          ...
          onDecide={showingTeam ? handleDecide : undefined}
          decidingId={deciding}
          highlightRequestId={bookingRequestId}
          emptyMessage={
            showingTeam
          ...
          emptyAction={
            showingTeam ? undefined : <BookTimeOffButton onBooked={refresh} />
          }
        />
      </div>
    </div>
